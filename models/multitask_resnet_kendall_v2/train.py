...
from models.multitask_resnet_kendall_v2.features import MelSpectrogramTransform
from models.multitask_resnet_kendall_v2.losses import KendallMultiTaskLoss
from models.multitask_resnet_kendall_v2.model import MultiTaskResNet


@dataclass
class TrainConfig:
    data_root: str = "mic_array_data"
    output_dir: str = "models/multitask_resnet_kendall_v2/runs/default"
    seed: int = 42
...
def parse_args() -> TrainConfig:
    ...
    parser.add_argument("--output-dir", default="models/multitask_resnet_kendall_v2/runs/default")
